...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2017 at 03:41 PM
...
--
-- Table structure for table `vertex_26`
--

CREATE TABLE IF NOT EXISTS `vertex_26` (
  `a` int(11) NOT NULL,
  `b` int(11) NOT NULL,
  `c` int(11) NOT NULL,
  `d` int(11) NOT NULL,
...
--
-- Dumping data for table `vertex_26`
--

INSERT INTO `vertex_26` (`a`, `b`, `c`, `d`, `e`, `f`, `g`, `h`, `i`, `j`, `k`, `l`, `m`, `n`, `o`, `p`, `q`, `r`, `s`, `t`, `u`, `v`, `w`, `x`, `y`, `z`) VALUES
